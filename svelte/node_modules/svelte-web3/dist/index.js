(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('svelte-proxied-store'), require('svelte/store')) :
  typeof define === 'function' && define.amd ? define(['exports', 'svelte-proxied-store', 'svelte/store'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.web3store = {}, global.svelteProxiedStore, global.store));
})(this, (function (exports, svelteProxiedStore, store) { 'use strict';
  ...
  const loadWeb3 = () => {
    if (exports.Web3.version) return
    try {
      exports.Web3 = getGlobalObject().Web3 || {};
    } catch (err) {
  ...
  const alwaysNumber = n => exports.Web3.utils.isHex(n) ? exports.Web3.utils.hexToNumber(n) : n;
  ...
  const createStore = () => {
    ...
    const init = () => {
      loadWeb3();
      if (!exports.Web3.version) throw new Error('[svelte-web3] Cannot find Web3')
    ...
    const set1193Provider = async (eipProvider, addressOrIndex) => {
      ...
      const web3 = new exports.Web3(eipProvider);
      assign({
        web3,
        eipProvider,
    ...
    const setProvider = async (provider, addressOrIndex = 0) => {
      ...
      init();
      const web3 = new exports.Web3(provider);
  ...
  const getData = id => {
    if (!id || !exports.Web3.utils) return noData
    if (exports.Web3.utils.isHexStrict(id)) id = exports.Web3.utils.hexToNumber(id);
  ...
  const makeEvmStores = name => {
    ...
    allStores[name].web3 = store.derived(evmStore, $evmStore => {
      if (!$evmStore.web3) return { utils: exports.Web3.utils, version: exports.Web3.version }
      return $evmStore.web3
    });

    allStores[name].selectedAccount = store.derived(
      evmStore,
    ...
    allStores[name].walletType = store.derived(evmStore, $evmStore => {
  ...
  const selectedAccount = allStores.default.selectedAccount;
  const web3 = allStores.default.web3;
