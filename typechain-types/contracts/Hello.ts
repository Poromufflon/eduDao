...
export interface HelloInterface extends utils.Interface {
  functions: {
    ...
    "setGreetie(string)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "setGreetie", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "transferOwnership",
    data: BytesLike
  ): Result;
...
export interface Hello extends BaseContract {
  ...
  functions: {
    ...
    setGreetie(
      _newGreetie: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
